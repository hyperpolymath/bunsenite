...
:experimental:
:url-github: https://github.com/hyperpolymath/bunsenite
:url-gitlab: https://gitlab.com/hyperpolymath/bunsenite
:url-bitbucket: https://bitbucket.org/hyperpolymath/bunsenite
:url-codeberg: https://codeberg.org/hyperpolymath/bunsenite

Chemical process simulation and lab automation
...
bunsenite is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
