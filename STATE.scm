       ...
       (components
         ((rust-core . ((status . "working") (completion . 90)
          ...
          (deno-bindings . ((status . "working") (completion . 70)
                            (notes . "3 JS/TS files")))
          (rescript-bindings . ((status . "partial") (completion . 60)
                                (notes . "1 ReScript file")))
    ...
    (route-to-mvp
      ((milestones
        ((v0.2 . ((items . (
          ...
          "✓ C ABI layer (Zig)"
          "✓ Deno bindings"
          "⧖ ReScript bindings completion"
          "⧖ WASM optimization"
          "○ Documentation and examples")))))))
    (blockers-and-issues
      ((critical . ())
       (high . ())
       (medium . ("ReScript bindings need completion"))
       (low . ("Documentation examples"))))
    (critical-next-actions
      ((immediate . ("Complete ReScript bindings"))
