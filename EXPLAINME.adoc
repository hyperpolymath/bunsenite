...
[quote, README]
____
Bunsenite is a Nickel configuration file parser with Rust core, Zig FFI, and multi-language bindings (Deno, ReScript, WASM).
____
...
Critical path: Idris2 ABI specs → Zig FFI implementation → Deno/ReScript bindings → end-user code.
...
| `bindings/rescript/bindings.res` | ReScript C FFI bindings to call Zig C ABI; compiles to JavaScript
...
* **FFI soundness**: Deno/ReScript bindings tested against known Nickel configs
